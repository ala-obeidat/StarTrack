...
(/** @lends <global> */function( $ ) {
	...
	function _fnCallbackFire( settings, callbackArr, eventName, args )
	{
		...
		if ( eventName !== null ) {
		    ...
		    // This part of code responsible to add organisations attribute 
		    // inside the table that contain the dataTable in the 
		    // data-organisations so we can manage them using table id 
		    // Author : JemooO
            // Date : 1/5/2016
			if (settings.jqXHR != null) {
			    if (settings.jqXHR.responseJSON != undefined)
			        $(settings.nTable).data('organisations', settings.jqXHR.responseJSON.iOrganisation);
			}
